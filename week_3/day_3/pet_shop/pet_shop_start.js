...
function searchOfPets(pets, search){
for (var name of pet){
if (name.pets.name === search){
    return petshop.pets.name
}
}
return "not found"
}
...
console.log(totalCost(myPetShop))
